...
var require_guestTokenRefresh = __commonJS({
  "node_modules/@superset-ui/embedded-sdk/lib/guestTokenRefresh.js"(exports) {
    ...
    var DEFAULT_TOKEN_REFRESH_RETRY_MS = exports.DEFAULT_TOKEN_REFRESH_RETRY_MS = 1e4;
...
var require_withTimeout = __commonJS({
  "node_modules/@superset-ui/embedded-sdk/lib/withTimeout.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
var require_lib = __commonJS({
  "node_modules/@superset-ui/embedded-sdk/lib/index.js"(exports) {
    ...
    var _withTimeout = require_withTimeout();
    var DEFAULT_GUEST_TOKEN_FETCH_TIMEOUT_MS = 3e4;
    async function embedDashboard({
      ...
      async function mountIframe() {
        return new Promise((resolve) => {
          ...
          const allowFeatures = Array.from(/* @__PURE__ */ new Set(["fullscreen", "clipboard-write", ...iframeAllowExtras]));
      ...
      let ourPort;
      try {
        [guestToken, ourPort] = await Promise.all([fetchGuestTokenWithTimeout(), mountIframe()]);
      } catch (err) {
      ...
      ourPort.start();
      ourPort.defineMethod("resolvePermalinkUrl", async ({
        key
      }) => {
        ...
        try {
          return await resolvePermalinkUrl({
            key
          });
        } catch (error) {
